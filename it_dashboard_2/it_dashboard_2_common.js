...
$(document).ready(function() {
    ...
    // add all nodes
    updateSNMPSensorNodes('/strendinmonitor/JSON/allsensors.aspx');

    // Does this have to be added and updated seperately as well? We'll find out
    updatePingSensorNodes('/strendinmonitor/JSON/allsensors.aspx');

    // Update total traffic counter
    updateTotalTrafficToday('/StrendinMonitor/JSON/bySNMPThroughputSensor.aspx?sensorid=1', '/StrendinMonitor/JSON/bySNMPThroughputSensor.aspx?sensorid=2');
    updateTotalTrafficThisMonth('/StrendinMonitor/JSON/bySNMPThroughputSensor.aspx?sensorid=1', '/StrendinMonitor/JSON/bySNMPThroughputSensor.aspx?sensorid=2');

    // Update graph
    updateBandwidthGraph('/StrendinMonitor/JSON/ByHost.aspx?hostid=1');
