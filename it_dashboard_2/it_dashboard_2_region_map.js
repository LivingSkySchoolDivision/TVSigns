...
*/
           ...
           // (canvasid, x, y, title, latency, displayPin, pinOnBottom, pinOnRight, customWidth)
            ...
            if (thisSensor.id == 82) {
               addPingNode(canvasid, 145,820,"FIM",thisSensor.lastsuccessfulroundtrip, thisSensor.health, false, false, false);
            }

            if (thisSensor.id == 83) {
               addPingNode(canvasid, 145,845,"FIM-Staff",thisSensor.lastsuccessfulroundtrip, thisSensor.health, false, false, false);
            }

            if (thisSensor.id == 84) {
               addPingNode(canvasid, 145,870,"GoogleSync",thisSensor.lastsuccessfulroundtrip, thisSensor.health, false, false, false);
            }
            ...
            if (thisSensor.id == 87) {
               addPingNode(canvasid, 10,820,"Backups",thisSensor.lastsuccessfulroundtrip, thisSensor.health, false, false, false);
            }

            if (thisSensor.id == 88) {
               addPingNode(canvasid, 10,845,"NODE",thisSensor.lastsuccessfulroundtrip, thisSensor.health, false, false, false);
            }

            if (thisSensor.id == 90) {
               addPingNode(canvasid, 10,870,"RADIUS",thisSensor.lastsuccessfulroundtrip, thisSensor.health, false, false, false);
            }
