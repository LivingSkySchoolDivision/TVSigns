...
function updateWeather(JSONPath) {
    ...
    $.ajax({ 
        url : "/LSKYDashboardDataCollector/Proxy/JSON.aspx?url=http://api.wunderground.com/api/bb5a09f62da58b68/geolookup/conditions/q/North_Battleford.json", 
        dataType : "json", 
    ...
    /*
    var JSONPath = "/LSKYDashboardDataCollector/Proxy/JSON.aspx?url=http://api.openweathermap.org/data/2.5/weather?q=North%20Battleford,%20SK"
